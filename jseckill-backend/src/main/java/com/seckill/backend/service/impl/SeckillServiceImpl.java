...
import com.seckill.backend.constant.RedisKey;
import com.seckill.backend.constant.RedisKeyPrefix;
import com.seckill.backend.dao.SeckillDAO;
import com.seckill.backend.dao.PayOrderDAO;
import com.seckill.backend.dao.cache.RedisDAO;
...
import com.seckill.backend.entity.PayOrder;
...
import com.seckill.backend.mq.MQProducer;
import com.seckill.backend.service.AccessLimitService;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    //md5盐值字符串,用于混淆MD5
    private static final String salt = "aksksks*&&^%%aaaa&^^%%*";
